...
class SFS_Admin {
    ...
    public function add_admin_menu() {
        add_menu_page(
            __('File Submissions', 'secure-file-submission'),
            __('File Submissions', 'secure-file-submission'),
        ...
        add_submenu_page(
            'sfs-submissions',
            __('Impostazioni', 'secure-file-submission'),
            __('Impostazioni', 'secure-file-submission'),
            'manage_file_submissions',
            'sfs-settings',
    ...
    public function register_settings() {
        ...
        register_setting('sfs_settings', 'sfs_min_free_space');
    ...
    public function handle_delete_submission() {
        ...
        wp_redirect(add_query_arg('page', 'sfs-submissions', admin_url('admin.php')));
        exit;
    }
}
